...
export const slides: SlideData[] = [
  ...
  // Slide 4: 설치 가이드
  {
    ...
    layout: 'code-focus',
    content: [
      { type: 'text', content: '1. Claude Code CLI 설치' },
      {
        type: 'code',
        language: 'bash',
      ...
      { type: 'spacer', size: 'sm' },
      { type: 'text', content: '2. API 키 설정 또는 Claude Max 구독 연동' },
      {
        type: 'code',
        language: 'bash',
        code: '# API 키 방식\nexport ANTHROPIC_API_KEY="sk-ant-..."\n\n# 또는 Claude Max 구독자는 자동 연동',
        filename: 'Terminal',
      },
      { type: 'spacer', size: 'sm' },
      { type: 'text', content: '3. oh-my-claudecode 플러그인 설치' },
      {
        type: 'code',
        language: 'bash',
        code: 'claude\n/install-plugin https://github.com/Yeachan-Heo/oh-my-claudecode',
